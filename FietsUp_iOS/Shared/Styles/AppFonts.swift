...
extension Font {
  ...
  static var body: Font { .custom(regular, size: 16, relativeTo: .body) }
  ...
  static var caption: Font { .custom(bold, size: 13, relativeTo: .caption) }
  ...
  static var data2: Font { .custom(bold, size: 24, relativeTo: .title) }
}
